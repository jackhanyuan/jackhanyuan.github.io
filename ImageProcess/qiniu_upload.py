...
#替换为自己的ak和sk
access_key = 'T9ZnwUrAHwi-NSEGuIqLgfx1Iqs_p9QcRQaUam8y'
secret_key = 'BRbMhkFwE-n38PHlthiKeVJeLIXGmRNHodDJZ6G5'

#替换为自己的域名
url = 'https://qiniu.findn.cn'

#替换为自己的仓库名
bucket_name = 'sanshui-blog'
#指定存储路径
