...
![htop查看进程 CPU异常](https://qiniu.findn.cn//blog/photos/article/20241009222539.png)
...
crontab -e
```
![查看定时任务](https://qiniu.findn.cn//blog/photos/article/20241009224602.png)
...
![定时任务异常文件](https://qiniu.findn.cn//blog/photos/article/20241009222808.png)
这里发现了异常文件`ntpdate`和`pwnrig`，可以看到文件修改时间为`9月28日 3点`，后面只要查到`文件在这个时间附近修改过`，就基本是`木马文件`。查看文件内容：
![ntpdate和pwnrig内容](https://qiniu.findn.cn//blog/photos/article/20241009223107.png)
...
```
![修改hosts限制网络](https://qiniu.findn.cn//blog/photos/article/20241009223307.png)
## 排查/bin /sbin
```sh
cd /bin
# 分析最近修改
...
rm -rf 文件名
```
![chattr移除文件属性](https://qiniu.findn.cn//blog/photos/article/20241009223354.png)
...
![用户目录下多个文件被篡改](https://qiniu.findn.cn//blog/photos/article/20241009224457.png)
...
```
![系统服务分析](https://qiniu.findn.cn//blog/photos/article/20241009223658.png)
...
````
![日志分析](https://qiniu.findn.cn//blog/photos/article/20241009223823.png)
